    ...
    initialize: async () => {
        ...
        const gridOptions = {
            ...
            columnDefs: [
                ...
                {headerName: i18next.t('DpsScore'), field: 'augmentedStats.DpsScore', cellRenderer: (params) => params.value == 0 ? "" : params.value},
                {headerName: i18next.t('ResSupportScore'), field: 'augmentedStats.ResSupportScore', cellRenderer: (params) => params.value == 0 ? "" : params.value},
                {headerName: i18next.t('EffSupportScore'), field: 'augmentedStats.EffSupportScore', cellRenderer: (params) => params.value == 0 ? "" : params.value},
                {headerName: i18next.t('AREScore'), field: 'augmentedStats.AREScore', cellRenderer: (params) => params.value == 0 ? "" : params.value},
